...
if IS_VERCEL:
    DB_FILE = Path(tempfile.gettempdir()) / "chat_history.sqlite3"
else:
...
class ChatHistoryDB:
    ...
    def _init_db(self):
        ...
        try:
            ...
            print(f"[ChatHistoryDB Init Warning] {e}")
    ...
    def create_session(self, initial_title: str = "New CyberRAG Chat") -> str:
        ...
        try:
            ...
            print(f"[ChatHistoryDB create_session Error] {e}")
        return session_id
    ...
    def add_message(self, session_id: str, sender: str, data: Dict[str, Any], auto_update_title: bool = False):
        ...
        try:
            ...
            print(f"[ChatHistoryDB add_message Error] {e}")
    ...
    def get_sessions(self) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            print(f"[ChatHistoryDB get_sessions Error] {e}")
            return []
    ...
    def get_session_messages(self, session_id: str) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            print(f"[ChatHistoryDB get_session_messages Error] {e}")
            return []
    ...
    def delete_session(self, session_id: str):
        ...
        try:
            ...
            print(f"[ChatHistoryDB delete_session Error] {e}")
    ...
    def clear_all_history(self):
        ...
        try:
            ...
            print(f"[ChatHistoryDB clear_all_history Error] {e}")
